...
const AdminDashboard = ({ data, formatCurrency, calculateTrend, getTrendColor, getStatusLabel }: AdminDashboardProps) => {
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={data.services.map((s: any) => ({ status: getStatusLabel(s.status), count: s.count }))}>
              <CartesianGrid strokeDasharray="3 3" />
