...
exports.WorkshopInfoModel = void 0;
...
class WorkshopInfoModel {
    ...
    static async find() {
        ...
        const result = await database_1.default.query('SELECT * FROM workshop_info WHERE id = 1 LIMIT 1');
    ...
    static async update(data) {
        ...
        values.push(1);
        const result = await database_1.default.query(`UPDATE workshop_info 
    ...
    static async create(data) {
        ...
        await this.ensureTableExists();
        const result = await database_1.default.query(`INSERT INTO workshop_info (
...
exports.WorkshopInfoModel = WorkshopInfoModel;
//# sourceMappingURL=workshop-info.model.js.map